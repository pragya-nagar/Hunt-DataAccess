...
{
    public partial class UpdateEtlStoredProcedureIsloanFlag : Migration
    {
                ...
                BEGIN
                    ...
                    (
                        ...
                        FROM stage.synergy_source_data psd
                            ...
                            LEFT JOIN main.""InternalLandUseCode"" iluc ON psd.internal_land_use_code = iluc.""Description""
                        WHERE psd.batch_id = p_batch_id
