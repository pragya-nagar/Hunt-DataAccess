...
{
    public partial class CreateSchemasAndTrigers : Migration
    {
            ...
            string sqlStageScript = @"
                ...
                BEGIN
	                ...
	                (
		                ...
		                FROM stage.synergy_source_data psd
			                INNER JOIN main.""Property"" p ON p.""PropertyBK"" = psd.property_bk
			                INNER JOIN main.""Delinquency"" d ON d.""PropertyId"" = p.""Id"" and d.""DelinquencyTaxYear"" = psd.delinquency_tax_year
		                WHERE property_bk IS NOT NULL
	                ...
	                FROM d
	                WHERE NOT EXISTS ( SELECT 1 FROM main.""Delinquency"" dl WHERE dl.""PropertyId"" = d.property_id AND dl.""DelinquencyTaxYear"" = d.delinquency_tax_year);



	                /* Update existing CollectingEntity */
	                WITH res AS
	                (
