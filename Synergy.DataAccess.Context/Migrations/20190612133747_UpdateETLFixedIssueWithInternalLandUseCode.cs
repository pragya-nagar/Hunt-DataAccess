...
{
    public partial class UpdateETLFixedIssueWithInternalLandUseCode : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string stageSchemaSQL = @"
                ...
                /* DROP add_profile_delinquency FUNCTION */
                DROP FUNCTION IF EXISTS stage.load_profile_delinquency();
                /* CREATE add_profile_delinquency FUNCTION */
                CREATE OR REPLACE FUNCTION stage.load_profile_delinquency()
                 RETURNS TABLE(updated_count numeric, inserted_count numeric)
                 LANGUAGE plpgsql
                AS $function$
                    DECLARE 
