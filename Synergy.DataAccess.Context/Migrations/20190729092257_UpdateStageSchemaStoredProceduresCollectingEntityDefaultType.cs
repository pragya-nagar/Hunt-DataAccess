...
{
    public partial class UpdateStageSchemaStoredProceduresCollectingEntityDefaultType : Migration
    {
                    ...
                    p_utotal = 0;
                        ...
                        WITH lead AS(
                                ...
                                WHERE EXISTS (SELECT 1 FROM main.""Property"" p
								                INNER JOIN stage.synergy_source_data sd ON p.""PropertyBK"" = sd.property_bk
								                LEFT JOIN main.""PropertyAudit"" pa ON pa.""Id"" = p.""Id"" 
								                WHERE sd.batch_id = 1 AND COALESCE(pa.""LeadId"", p.""LeadId"") = l.""Id"")
                                GROUP BY l.""Id""  
                                )
                         UPDATE main.""Lead"" l
