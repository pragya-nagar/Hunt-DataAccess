...
{
    public partial class ChangeDecisionTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<Guid>(
                name: "PropertyProfileId",
                schema: "main",
                table: "DecisionAudit",
                nullable: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Decision_PropertyProfileId",
                schema: "main",
                table: "Decision",
                column: "PropertyProfileId");

            migrationBuilder.AddForeignKey(
                name: "FK_Decision_PropertyProfile_PropertyProfileId",
                schema: "main",
                table: "Decision",
                column: "PropertyProfileId",
